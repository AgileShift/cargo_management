...
def mark_shipment_in_transit(source_name: str):
    """ Used as Action button in Doctype: Change status of the packages and the warehouses receipts of the shipment. """
...
Se crea la hoja de recepcion, que contiene el shipment, los warehouses y los packages.
...
Cuando se crean las facturas, el package cambia a Available for Pikcup y se le hace el Link

Cuando Una sales Invoice es Pagada el package cambia a Finished.
"""

""" 
Packages missing on the shipment receipt
