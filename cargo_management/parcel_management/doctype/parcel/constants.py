...
class Status(StrEnum):
    AWAIT_RECEIPT = 'Awaiting Receipt'
    AWAIT_CONFIRM = 'Awaiting Confirmation'
    RETURN_TO_SENDER = 'Returned to Sender'
    IN_TRANSIT = 'In Transit'
    AWAIT_DEPARTURE = 'Awaiting Departure'
    TO_BILL = 'To Bill'
    DELIVERY_OR_PICKUP = 'For Delivery or Pickup'
    UNPAID = 'Unpaid'
    IN_EXTRA_CONFIRMATION = 'In Extraordinary Confirmation'
    FINISHED = 'Finished'
    CANCELLED = 'Cancelled'
    IN_CUSTOM = 'In Customs'
    SORTING = 'Sorting'
